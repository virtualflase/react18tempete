...
module.exports = {
  ...
  "extends": ['eslint:recommended', // create react app已安装，使用eslint中recommened的规则
  ...
  // 需手动安装 @typescript-eslint/parser，This allows Eslint to understand TypeScript syntax
  "parserOptions": {
    "ecmaVersion": 11,
    "ecmaFeatures": {
